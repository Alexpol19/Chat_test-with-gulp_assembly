...
//// для быстрого показа клиенту сайта в интернете
    ...
    gulp.watch(['app/pug/*.pug', 'app/include/**'], ['pug']).on('change', browserSync.reload);//если изменения в pug и include/*.pug ! но нес разу после gulp, а после изменения в .pug
...
gulp.task('default', ['pug', 'serve', 'images',  'copy_html', 'copy_js', 'copy_fonts', 'copy_bootstrap']);/* некоторые команды сразу копируются и не следят больше за фалами. */